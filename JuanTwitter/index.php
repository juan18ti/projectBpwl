...
define('CONSUMER_KEY', 'QENla8MnhS9Wf31GTuN7Kqm1b');
define('CONSUMER_SECRET', 'nWM5ZvfcO0HSJNfuOgLBOCiScTibVMuiGWE6HtkvBgSiZPeSrl');
define('OAUTH_CALLBACK', 'http://localhost/JuanTwitter/');
// start the session
session_start();
